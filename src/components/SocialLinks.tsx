...
export const SocialLinks = () => (
    <div className="fixed left-8 top-1/2 -translate-y-1/2 flex flex-col gap-6">
        ...
        <SocialLink href="https://l.nekomimi.pet/twitter?source=nekomimi.pet" label="Twitter">
            <div className="flex items-center gap-3 text-lg">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <SocialLink href="https://l.nekomimi.pet/bsky?source=nekomimi.pet" label="Bluesky">
            <div className="flex items-center gap-3 text-lg">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
