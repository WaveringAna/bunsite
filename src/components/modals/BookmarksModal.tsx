    ...
    return (
        ...
        >
            <div id="bookmarks-modal" className="flex flex-col h-full">
                ...
                <p className="text-white text-sm mb-6">Things I found interesting.</p>
                <div className="flex flex-col gap-5 overflow-y-auto pr-1">
                    {sortedDates.map(date => (
                        <div key={date} className="space-y-2">
                            ...
                            <div className="flex flex-col divide-y divide-black/20 backdrop-blur-sm bg-white/10 rounded-xl overflow-hidden inset-shadow-sm">
                                {grouped[date].map((bm, i) => (
                                    ...
                                    >
                                        <div className="flex flex-col">
                                            <div className="text-base font-medium text-white mb-1 group-hover:text-cyan-100 transition-colors">{bm.title}</div>
                                            {bm.description && (
                                            ...
                                            <div className="text-white text-xs flex justify-between items-center">
                                                <span>{bm.author}</span>
                                                <svg className="w-4 h-4 text-white group-hover:text-cyan-100 transition-colors" viewBox="0 0 20 20" fill="currentColor">
